...
const QuickPayTransactionModal = ({
  modalOpen,
  setModalOpen,
  addTransaction,
  defaultReceiver,
  ...
  useEffect(() => {
    // Update receiver state if defaultReceiver prop changes
        ...
        <div className="flex w-full flex-col space-y-2">
          <div className="flex rounded-lg border border-gray-200 p-4">
            ...
            <input
              ...
              value={receiver}
              onChange={(e) => !isReceiverDisabled && setReceiver(e.target.value)} 
...
export default QuickPayTransactionModal;
